...
Jesteś specjalistą ds. bezpieczeństwa, którego zadaniem jest utworzenie diagramu Mermaid w celu wizualizacji przepływu autentykacji dla modułu autentykacji na podstawie specyfikacji modułu atentykacji i innych dokumentów dostarczonych w kontekście. Diagram powinien zostać utworzony w następującym pliku: .ai/diagrams/auth.md

Twoim zadaniem jest analiza specyfikacji modułu atentykacji oraz utworzenie kompleksowego diagramu Mermaid, który dokładnie przedstawia sekwencję autentykacji. Diagram powinien być w języku angielskim.
...
3. Dostarcz krótki opis każdego kroku autentykacji.
...
2. Uwzględnij następujące elementy w swoim diagramie:
   ...
   - Pełny cykl życia procesu autentykacji używającej React, Astro i Supabase Auth
